  ...
  private def retrievePoliticalAction(): Seq[PoliticalAction] =
    Seq(
      PoliticalAction(
        ...
        text =
          "Marchez pour le climat avec WWF et rejoignez le mouvement où que vous soyez en commandant votre kit #MarcheClimat. "
      ),
      PoliticalAction(
        ...
        text =
          "Amis joggueurs, \"la Course pour la planète\" est pour vous ! Zero Waste France vous propose d'allier jogging et environnement. "
      ),
      PoliticalAction(
        ...
        text =
          "France Nature Environnement vous invite à la semaine de l'éco-mobilité : ateliers, conférences et innovation sont au rdv ! "
      )
    )
