...
object ConsultationPresentationMobile {

  case class ConsultationPresentationMobileProps(content: String, learnMoreUrl: Option[String] = None)

  lazy val reactClass: ReactClass =
    React
      .createClass[ConsultationPresentationMobileProps, Unit](
        displayName = "ConsultationPresentationMobile",
        render = { self =>
          def onclick(url: String): () => Unit = { () =>
            scalajs.js.Dynamic.global.window.open(url, "_blank")
          }
          <.article(^.className := ConsultationPresentationMobileStyles.wrapper)(
            <.div(^.className := ConsultationPresentationMobileStyles.contentWrapper)(
            ...
            <.style()(ConsultationPresentationMobileStyles.render[String])
          )
        }
      )
...
object ConsultationPresentationMobileStyles extends StyleSheet.Inline {
  import dsl._
