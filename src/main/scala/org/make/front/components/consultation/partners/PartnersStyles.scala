...
object PartnersStyles extends StyleSheet.Inline {
  ...
  val wrapper: StyleA =
    style(
      ...
      ThemeStyles.MediaQueries.beyondLargeMedium(paddingLeft(20.pxToEm()), paddingRight(20.pxToEm()))
    )
  ...
  val item: StyleA =
    style(
      ...
      ThemeStyles.MediaQueries.beyondLargeMedium(width(50.pxToPercent(320)))
    )
