  ...
  lazy val reactClass: ReactClass =
    React
      ...
      render = { self =>
        ...
        <.aside(^.className := RWDHideRulesStyles.hideBeyondLargeMedium)(
          <.button(
            ^.className := js.Array(
...
object ConsultationShareMobileStyles extends StyleSheet.Inline {
  ...
  val shareIcon: StyleA =
    style(
      color(ThemeStyles.BackgroundColor.white)
    )
  ...
  val closeIcon: StyleA =
    style(
      color(ThemeStyles.BackgroundColor.black)
    )
