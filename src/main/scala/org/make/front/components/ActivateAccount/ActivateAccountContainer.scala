...
import org.make.front.components.ActivateAccount.ActivateAccountComponent
import org.make.front.components.ActivateAccount.ActivateAccountComponent.ActivateAccountProps
