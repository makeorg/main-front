    ...
    React
      .createClass[Unit, Unit](
        ...
        render = self => {
          ...
          <.div(^.className := js.Array(WaitingForActorProfileStyles.wrapper, TableLayoutStyles.fullHeightWrapper))(
            <.div(^.className := TableLayoutStyles.row)(
              <.div(^.className := js.Array(TableLayoutStyles.cell, WaitingForActorProfileStyles.mainHeaderWrapper))(
                <.div(^.className := RWDHideRulesStyles.invisible)(<.CookieAlertContainerComponent.empty),
                <.div(^.className := WaitingForActorProfileStyles.fixedMainHeaderWrapper)(
