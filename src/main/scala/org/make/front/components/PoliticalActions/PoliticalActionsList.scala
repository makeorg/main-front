package org.make.front.components.PoliticalActionss
...
object PoliticalActionsListComponent {

  final case class PoliticalActionsListProps(politicalActions: Seq[PoliticalAction])
